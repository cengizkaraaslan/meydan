...
export const MUNICIPALITY_CONFIGS: MunicipalityConfig[] = [
  ...
  // NOT: adana.bel.tr — /tr/etkinlik route döner ama body boş (yayınlanmış etkinlik yok). Selector eklemenin anlamı yok, yapısal şablon hazır olduğunda site içerik dönecek.
  ...
  { source: "MUNI_MERSIN",        displayName: "Mersin BB",         baseUrl: "https://www.mersin.bel.tr",           eventListPath: "/etkinlikler",     city: "Mersin" },
  { source: "MUNI_KAYSERI",       displayName: "Kayseri BB",        baseUrl: "https://www.kayseri.bel.tr",          eventListPath: "/etkinlikler",     city: "Kayseri" },
  ...
  { source: "MUNI_HATAY",         displayName: "Hatay BB",          baseUrl: "https://www.hatay.bel.tr",            eventListPath: "/etkinlikler",     city: "Hatay" },
  ...
  { source: "MUNI_ORDU",          displayName: "Ordu BB",           baseUrl: "https://www.ordu.bel.tr",             eventListPath: "/etkinlikler",     city: "Ordu" },
...
export const ISTANBUL_DISTRICT_CONFIGS: MunicipalityConfig[] = [
  ...
  // NOT: beyoglu.bel.tr WordPress, ayrı etkinlik post type'ı yok. /kategori/haberler/ count=0. /sanat/* kategori sayfaları AJAX-yüklü .newsListRow boş döner.
  // Site etkinlik takvimi yayınlamıyor — selector denesek de boş döner.
  { source: "MUNI_BEYOGLU", displayName: "Beyoğlu Bld", baseUrl: "https://beyoglu.bel.tr", eventListPath: "/kategori/haberler/", city: "İstanbul" },
  // Üsküdar: ana sayfa (/tr/main/eventcalendar) calendar AJAX-yüklü, ama ajandaDetay endpoint'i etkinlikleri SSR HTML olarak döner (a.fc-day-grid-event + span.fc-title).
  {
    source: "MUNI_USKUDAR",
