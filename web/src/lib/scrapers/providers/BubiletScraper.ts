...
export class BubiletScraper extends TicketingScraper {
  public readonly source: EventSource = "BUBILET";
  public readonly displayName = "Bubilet";
  public readonly baseUrl = "https://www.bubilet.com.tr";
