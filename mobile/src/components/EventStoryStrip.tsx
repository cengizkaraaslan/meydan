 ...
 */
export function EventStoryStrip({ myGroup, mockGroups, onOpen, onShare }: Props) {
  const { t: T } = useTheme();
  ...
  return (
    ...
    >
      {/* Paylaş (kendi story'ni ekle) */}
      <Pressable onPress={onShare} style={{ alignItems: "center", width: 68 }}>
        <View
          style={{
